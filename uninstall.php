...
if ( get_option( 'moneiuwc_delete_options_uninstall' ) ) {
	//defining options to remove as variables ..
		$moneiuwc_option_remove_remove_email					= 'moneiuwc_remove_email';
		$moneiuwc_option_remove_remove_website					= 'moneiuwc_remove_website';
		$moneiuwc_option_remove_empty_notes						= 'moneiuwc_empty_notes';
		$moneiuwc_option_remove_discard_ip						= 'moneiuwc_discard_ip';
		$moneiuwc_option_remove_remove_cookie					= 'moneiuwc_remove_cookie';
	...
	// removing the options ..
		delete_option( $moneiuwc_option_remove_display_email );
		delete_option( $moneiuwc_option_remove_display_website );
